...
//         fontSize,
//       }}
//       className={`inline-flex items-center justify-center leading-normal shadow-md transition duration-150 ease-in-out hover:opacity-80 focus:opacity-90 active:opacity-100 bebas-regular rounded-${rounded} ${
//         uppercase ? "uppercase" : ""
//       } ${className}`}
//     >
//       {text}
