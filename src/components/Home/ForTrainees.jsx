...
function ForTrainees() {
  ...
  return (
    <section ref={sectionRef} className="w-full bg-gradient-to-r from-blue-50/40 via-background to-cyan-50/40 py-20">
      <div className="mx-auto flex w-full max-w-7xl px-4 sm:px-6 flex-col overflow-hidden rounded-[32px] border-2 border-cyan-200 bg-gradient-to-br from-white via-blue-50/20 to-white shadow-lg lg:flex-row">
        <div
          className={`flex flex-1 flex-col justify-center gap-10 px-6 py-12 transition-all duration-700 ease-out sm:px-10 lg:px-12 ${isVisible ? "translate-x-0 opacity-100" : "-translate-x-8 opacity-0"
            }`}
        >
        ...
        <div
          className={`relative h-80 w-full flex-1 transition-all duration-700 delay-300 ease-out lg:h-auto ${isVisible ? "translate-x-0 opacity-100" : "translate-x-8 opacity-0"
            }`}
        >
